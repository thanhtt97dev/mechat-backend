...
public class RepositoryEntityBase<TEntity, TKey> : RepositoryBase<TEntity>, IRepositoryEnitityBase<TEntity, TKey>  where TEntity : DomainEntity<TKey>
{
    public RepositoryEntityBase(ApplicationDbContext context) : base(context)
    {
    }
